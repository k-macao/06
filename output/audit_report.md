...
- **审计时间**：2026-08-21T03:12:35.531837+00:00
- **KOL 目录**：97（本次入报 64，隔离 33）
- **判定**：PASS 10　|　WARN 87　|　FAIL 0
- **内容条目**：192 条；模拟/伪链接 0；改写标题 0
- **在线复核**：已请求（仅复核入报频道）
- **⚠️ 风控提示**：43 条在线 404 因同期大批频道同时出现，判定为 YouTube 反爬拦截而非频道失效，已从 FAIL 降级为 WARN。
...
|  2 | Andrei Jikh | 是 | YouTube | **WARN** | 0/3 | RSS 复验 404（疑似 YouTube 风控拦截，抓取阶段已验证）: UCGy7SkBjcIAgTiwkXEtPnYg |
|  3 | Humphrey Yang | 是 | TikTok/YT | **WARN** | 0/3 | RSS 404，channel_id 无效: UCFBpVaKCC0ajGps1vf0AgBg（同期大批频道 404，疑似 YouTube 风控拦截，已降级） |
|  4 | The Plain Bagel | 是 | YouTube | **WARN** | 0/3 | RSS 复验 404（疑似 YouTube 风控拦截，抓取阶段已验证）: UCFCEuCsyWP0YkP3CZ3Mr01Q |
|  5 | Patrick Boyle | 是 | YouTube | **PASS** | 0/3 |  |
|  6 | Meet Kevin | 是 | YouTube | **WARN** | 0/3 | RSS 复验 404（疑似 YouTube 风控拦截，抓取阶段已验证）: UCUvvj5lwue7PspotMDjk5UA |
...
| 14 | Jaspreet Singh | 是 | YouTube | **WARN** | 0/3 | RSS 复验 404（疑似 YouTube 风控拦截，抓取阶段已验证）: UCT3EznhW_CNFcfOlyDNTLLw |
| 15 | Investing with Rose | 是 | YouTube | **WARN** | 0/3 | RSS 复验 404（疑似 YouTube 风控拦截，抓取阶段已验证）: UCIbslwukNCyVp-XMz_2-gmw |
| 16 | ClearValue Tax | 是 | YouTube | **WARN** | 0/3 | RSS 复验 404（疑似 YouTube 风控拦截，抓取阶段已验证）: UCigUBIf-zt_DA6xyOQtq2WA |
| 17 | Everything Money | 是 | YouTube | **PASS** | 0/3 |  |
| 18 | New Money | 是 | YouTube | **WARN** | 0/3 | RSS 复验 404（疑似 YouTube 风控拦截，抓取阶段已验证）: UCvSXMi2LebwJEM1s4bz5IBA |
...
| 38 | PensionCraft | 是 | YouTube | **WARN** | 0/3 | RSS 复验 404（疑似 YouTube 风控拦截，抓取阶段已验证）: UC9OIwUcx-Uss7xj7s1P5XGw |
...
| 53 | 硬核刘大 | 是 | YouTube | **WARN** | 0/3 | RSS 复验 404（疑似 YouTube 风控拦截，抓取阶段已验证）: UCCeMdcZw1LJsAGKeoYXZw6A |
...
| 68 | 老蛮频道（数据帝老蛮） | 是 | YouTube | **WARN** | 0/3 | RSS 复验 404（疑似 YouTube 风控拦截，抓取阶段已验证）: UCrAC23izk57G7jCBPfdXGkg |
