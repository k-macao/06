...
- **审计时间**：2026-08-25T03:08:15.763630+00:00
- **KOL 目录**：97（本次入报 64，隔离 33）
- **判定**：PASS 5　|　WARN 92　|　FAIL 0
- **内容条目**：192 条；模拟/伪链接 0；改写标题 0
- **在线复核**：已请求（仅复核入报频道）
- **⚠️ 风控提示**：47 条在线 404 因同期大批频道同时出现，判定为 YouTube 反爬拦截而非频道失效，已从 FAIL 降级为 WARN。
...
|---|------|------|------|------|-----------|---------|
|  1 | Graham Stephan | 是 | YouTube | **WARN** | 0/3 | RSS 复验 404（疑似 YouTube 风控拦截，抓取阶段已验证）: UCV6KDgJskWaEckne5aPA0aQ |
...
|  5 | Patrick Boyle | 是 | YouTube | **WARN** | 0/3 | RSS 复验 404（疑似 YouTube 风控拦截，抓取阶段已验证）: UCASM0cgfkJxQ1ICmRilfHLw |
|  6 | Meet Kevin | 是 | YouTube | **WARN** | 0/3 | RSS 404，channel_id 无效: UCUvvj5lwue7PspotMDjk5UA（同期大批频道 404，疑似 YouTube 风控拦截，已降级） |
...
|  9 | Mark Tilbury | 是 | TikTok/YT | **WARN** | 0/3 | RSS 复验 404（疑似 YouTube 风控拦截，抓取阶段已验证）: UCxgAuX3XZROujMmGphN_scA |
| 10 | Jeremy Lefebvre | 是 | YouTube | **WARN** | 0/3 | RSS 复验 404（疑似 YouTube 风控拦截，抓取阶段已验证）: UCnMn36GT_H0X-w5_ckLtlgQ |
| 11 | Ben Felix | 是 | YouTube | **PASS** | 0/3 |  |
| 12 | Erika Kullberg | 是 | TikTok/YT | **WARN** | 0/3 | handle 缺失；RSS 复验 404（疑似 YouTube 风控拦截，抓取阶段已验证）: UCoSw1rKMkCbwzKpkC0OjRKA |
...
| 15 | Investing with Rose | 是 | YouTube | **WARN** | 0/3 | RSS 复验 404（疑似 YouTube 风控拦截，抓取阶段已验证）: UCIbslwukNCyVp-XMz_2-gmw |
| 16 | ClearValue Tax | 是 | YouTube | **WARN** | 0/3 | RSS 404，channel_id 无效: UCigUBIf-zt_DA6xyOQtq2WA（同期大批频道 404，疑似 YouTube 风控拦截，已降级） |
| 17 | Everything Money | 是 | YouTube | **WARN** | 0/3 | RSS 复验 404（疑似 YouTube 风控拦截，抓取阶段已验证）: UChBVf9YnourrEDTsbbwJPRA |
...
| 20 | Brian Feroldi | 是 | YouTube | **WARN** | 0/3 | RSS 复验 404（疑似 YouTube 风控拦截，抓取阶段已验证）: UCs60_Z83HU76uygzHRQl0kA |
| 21 | 贝拉聊财金 | 是 | YouTube | **WARN** | 0/3 | RSS 复验 404（疑似 YouTube 风控拦截，抓取阶段已验证）: UCVomjkM_t0EcctTWSE1Jvxg |
...
| 35 | Kelvin Learns Investing | 是 | YouTube | **WARN** | 0/3 | RSS 复验 404（疑似 YouTube 风控拦截，抓取阶段已验证）: UCJmaaSJX_PkfUmTuxWbrzLw |
...
| 43 | Cameron Stewart | 是 | YouTube | **WARN** | 0/3 | RSS 复验 404（疑似 YouTube 风控拦截，抓取阶段已验证）: UCpJRuue8x5Qag2Wz6uAzyjw |
| 44 | Fast Graphs (Chuck Carne | 是 | YouTube | **WARN** | 0/3 | RSS 404，channel_id 无效: UCJggpN5VY0PWKoOyBBT0R8A（同期大批频道 404，疑似 YouTube 风控拦截，已降级） |
...
| 53 | 硬核刘大 | 是 | YouTube | **WARN** | 0/3 | RSS 404，channel_id 无效: UCCeMdcZw1LJsAGKeoYXZw6A（同期大批频道 404，疑似 YouTube 风控拦截，已降级） |
...
| 55 | Finance730 | 是 | YouTube/財經媒體 | **WARN** | 0/3 | RSS 复验 404（疑似 YouTube 风控拦截，抓取阶段已验证）: UCzM2jQWmoeTvpEw63x5Rsdg |
...
| 68 | 老蛮频道（数据帝老蛮） | 是 | YouTube | **WARN** | 0/3 | RSS 404，channel_id 无效: UCrAC23izk57G7jCBPfdXGkg（同期大批频道 404，疑似 YouTube 风控拦截，已降级） |
| 69 | 秦鹏观察 | 是 | YouTube | **WARN** | 0/3 | fans 缺失/未填写；RSS 404，channel_id 无效: UCrYc9TEMHjiHNrNl6WpqLbQ（同期大批频道 404，疑似 YouTube 风控拦截，已降级） |
...
| 81 | 游庭皓的財經皓角 | 是 | YouTube | **WARN** | 0/3 | RSS 404，channel_id 无效: UC0lbAQVpenvfA2QqzsRtL_g（同期大批频道 404，疑似 YouTube 风控拦截，已降级） |
...
| 88 | 慢活夫妻 George & Dewi | 是 | YouTube | **WARN** | 0/3 | RSS 404，channel_id 无效: UCVNqvJSKVl0bsdb15gKUZfg（同期大批频道 404，疑似 YouTube 风控拦截，已降级） |
| 89 | 大俠武林 | 是 | YouTube | **WARN** | 0/3 | fans 缺失/未填写；RSS 404，channel_id 无效: UC-b6b7CGlRsdcRS7bXDvTYQ（同期大批频道 404，疑似 YouTube 风控拦截，已降级） |
...
| 95 | 蕾咪Rami | 是 | YouTube | **WARN** | 0/3 | RSS 404，channel_id 无效: UCGX-lnOzsVjbdzb1VJxmWSg（同期大批频道 404，疑似 YouTube 风控拦截，已降级） |
