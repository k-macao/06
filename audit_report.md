...
- **审计时间**：2026-09-05T06:54:19.047877+00:00
- **KOL 目录**：97（本次入报 64，隔离 33）
- **判定**：PASS 3　|　WARN 94　|　FAIL 0
- **内容条目**：192 条；模拟/伪链接 0；改写标题 0
- **在线复核**：已请求（仅复核入报频道）
- **⚠️ 风控提示**：56 条在线 404 因同期大批频道同时出现，判定为 YouTube 反爬拦截而非频道失效，已从 FAIL 降级为 WARN。
...
|  4 | The Plain Bagel | 是 | YouTube | **WARN** | 0/3 | RSS 404，channel_id 无效: UCFCEuCsyWP0YkP3CZ3Mr01Q（同期大批频道 404，疑似 YouTube 风控拦截，已降级） |
...
|  7 | Joseph Carlson | 是 | YouTube | **WARN** | 0/3 | RSS 复验 404（疑似 YouTube 风控拦截，抓取阶段已验证）: UCbta0n8i6Rljh0obO7HzG9A |
...
| 11 | Ben Felix | 是 | YouTube | **WARN** | 0/3 | RSS 404，channel_id 无效: UCDXTQ8nWmx_EhZ2v-kp7QxA（同期大批频道 404，疑似 YouTube 风控拦截，已降级） |
...
| 51 | 老厉害 | 是 | YouTube | **WARN** | 0/3 | RSS 复验 404（疑似 YouTube 风控拦截，抓取阶段已验证）: UC8gZZWIWmBuCb_gzC8DUrvw |
...
| 78 | 文昭谈古论今 | 是 | YouTube | **WARN** | 0/3 | RSS 404，channel_id 无效: UCtAIPjABiQD3qjlEl1T5VpA（同期大批频道 404，疑似 YouTube 风控拦截，已降级） |
...
| 83 | 风傳媒-下班经济學 | 是 | YouTube | **WARN** | 0/3 | RSS 复验 404（疑似 YouTube 风控拦截，抓取阶段已验证）: UCwWXGnvVmi-6Sfx2wf8S8tQ |
