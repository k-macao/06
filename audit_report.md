...
- **审计时间**：2026-08-19T03:12:46.144889+00:00
- **KOL 目录**：97（本次入报 64，隔离 33）
- **判定**：PASS 10　|　WARN 87　|　FAIL 0
- **内容条目**：192 条；模拟/伪链接 0；改写标题 0
- **在线复核**：已请求（仅复核入报频道）
- **⚠️ 风控提示**：49 条在线 404 因同期大批频道同时出现，判定为 YouTube 反爬拦截而非频道失效，已从 FAIL 降级为 WARN。
...
|  3 | Humphrey Yang | 是 | TikTok/YT | **WARN** | 0/3 | RSS HTTP 500 |
...
| 95 | 蕾咪Rami | 是 | YouTube | **WARN** | 0/3 | RSS 复验 404（疑似 YouTube 风控拦截，抓取阶段已验证）: UCGX-lnOzsVjbdzb1VJxmWSg |
