...
- **审计时间**：2026-08-26T03:15:58.437597+00:00
- **KOL 目录**：97（本次入报 64，隔离 33）
- **判定**：PASS 3　|　WARN 94　|　FAIL 0
- **内容条目**：192 条；模拟/伪链接 0；改写标题 0
- **在线复核**：已请求（仅复核入报频道）
- **⚠️ 风控提示**：58 条在线 404 因同期大批频道同时出现，判定为 YouTube 反爬拦截而非频道失效，已从 FAIL 降级为 WARN。
...
| 85 | SHIN LI | 是 | YouTube | **WARN** | 0/3 | RSS 复验 404（疑似 YouTube 风控拦截，抓取阶段已验证）: UCK-qc_POQZwWrMg-Pr-oYtg |
...
| 91 | Gooaye股癌 | 是 | YouTube | **WARN** | 0/3 | RSS 复验 404（疑似 YouTube 风控拦截，抓取阶段已验证）: UC23rnlQU_qE3cec9x709peA |
